...
def post_status(result_file: str, dashboard_url: str, project_slug: str) -> bool:
    ...
    try:
        ...
        print(f"⚠ Dashboard unreachable ({exc.reason}) — bỏ qua, tiếp tục bình thường")
        return True
...
def main():
    ...
    parser.add_argument("--result-file", required=True, help="Path to result.json or validation.json")
    parser.add_argument("--dashboard-url", default="", help="Dashboard base URL")
    parser.add_argument("--project-slug", default="", help="Project slug on the dashboard")
